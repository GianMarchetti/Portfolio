  ...
  return (
    <>
      <section className="w-full flex flex-col items-center p-8" id="contact">
        <h2 className="text-3xl font-bold relative mb-4 uppercase border-b-5 border-red-700 dark:border-red-900">
          Reach me out via:
        </h2>
        ...
        <div className="flex flex-col items-start my-4 p-2">
          ...
          <Link
            ...
            href="https://www.linkedin.com/in/gian-marchetti-8713ba1b6/"
          >
        ...
        <form
          ...
          className="form w-full justify-between items-center p-8"
        >
          ...
          <div className="flex justify-between items-center md:flex-col gap-2 w-full mb-2">
            <input
              ...
              placeholder="Name"
              className="bg-slate-200 dark:bg-zinc-800 h-10 mb-2 text-white dark:text-black rounded-md p-4 w-full sm:p-2 "
            />
            <input
              type="email"
              value={email}
          ...
          <textarea
            ...
            placeholder="Message"
            className="bg-slate-200 dark:bg-zinc-800 h-32 text-white dark:text-black rounded-md p-4 sm:p-2 w-full"
          ></textarea>

          <input
            type="submit"
            value="Send"
            className="bg-red-700 dark:bg-red-900 text-black dark:text-slate-300 font-bold text-lg rounded-md mt-4 py-3 px-6 w-fit cursor-pointer hover:translate-y-1 shadow-md shadow-slate-950 dark:shadow-black"
          />
        </form>
      </section>
    </>
